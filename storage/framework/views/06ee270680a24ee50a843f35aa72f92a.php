    ...
    <div class="max-w-2xl p-4 mx-auto rounded-lg bg-slate-200 dark:bg-slate-900">
        ...
        <form action="<?php echo e(route('admin.posts.update', $post->id)); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <input type="text" id="default-input" name="title" value="<?php echo e(old('title', $post->title)); ?>"
                class="
...
unset($__errorArgs, $__bag); ?>
                block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Write your thoughts here..."><?php echo e(old('content', $post->content)); ?></textarea>
                <?php $__errorArgs = ['content'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\laravelSetup\resources\views/admin/posts/edit.blade.php ENDPATH**/ ?>